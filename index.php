            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-5 text-left mt-5">
                        <h5>Tgc</h5>
                        <p style="" class="mt-4 text-justify">
                            Far far away, behind the word mountains,  far from <br> the countries Vokalia and Consonantia, there live <br> the blind texts.
                        </p>
                        <h5>Conecte-se</h5>
                        <a href="" title="Instagram" class="icon-conect">
                        ...
                        <a href="" title="Linkedin" class="icon-conect">
